	...
	public void receive(@Payload List<PaymentResponseAvroModel> messages,
		...
		messages.forEach(message -> {
			if (PaymentStatus.COMPLETED == message.getPaymentStatus()) {
				...
				paymentResponseEventListener.paymentApproved(
						orderMessagingMapper.paymentResponseAvroModelToPaymentResponse(message));
				...
				paymentResponseEventListener.paymentCancelled(
						orderMessagingMapper.paymentResponseAvroModelToPaymentResponse(message));
			}
