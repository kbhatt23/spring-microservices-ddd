...
public class RestaurantApprovalOutboxScheduler implements OutboxScheduler {
    ...
    private final RestaurantApprovalRequestOutboxMessagePublisher restaurantApprovalRequestMessagePublisher;

    public RestaurantApprovalOutboxScheduler(ApprovalOutboxHelper
                                                     approvalOutboxHelper,
                                                     RestaurantApprovalRequestOutboxMessagePublisher
