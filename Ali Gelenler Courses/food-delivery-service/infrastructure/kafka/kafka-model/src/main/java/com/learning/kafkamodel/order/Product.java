...
public class Product extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 753856882628420180L;


  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Product\",\"namespace\":\"com.learning.kafkamodel.order\",\"fields\":[{\"name\":\"id\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"},\"logicalType\":\"uuid\"},{\"name\":\"quantity\",\"type\":\"int\"}]}");
   ...
   */
  public static com.learning.kafkamodel.order.Product.Builder newBuilder() {
    return new com.learning.kafkamodel.order.Product.Builder();
  }
   ...
   * @return A new Product RecordBuilder
   */
  public static com.learning.kafkamodel.order.Product.Builder newBuilder(com.learning.kafkamodel.order.Product.Builder other) {
    if (other == null) {
      return new com.learning.kafkamodel.order.Product.Builder();
    } else {
      return new com.learning.kafkamodel.order.Product.Builder(other);
    }
  }
   ...
   * @return A new Product RecordBuilder
   */
  public static com.learning.kafkamodel.order.Product.Builder newBuilder(com.learning.kafkamodel.order.Product other) {
    if (other == null) {
      return new com.learning.kafkamodel.order.Product.Builder();
    } else {
      return new com.learning.kafkamodel.order.Product.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Product>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.learning.kafkamodel.order.Product.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.learning.kafkamodel.order.Product other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.id)) {
        this.id = data().deepCopy(fields()[0].schema(), other.id);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.learning.kafkamodel.order.Product.Builder setId(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.learning.kafkamodel.order.Product.Builder clearId() {
      id = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.learning.kafkamodel.order.Product.Builder setQuantity(int value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.learning.kafkamodel.order.Product.Builder clearQuantity() {
