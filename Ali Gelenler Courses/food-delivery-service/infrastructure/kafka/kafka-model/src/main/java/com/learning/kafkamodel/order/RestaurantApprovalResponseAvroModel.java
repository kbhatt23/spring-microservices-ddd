...
public class RestaurantApprovalResponseAvroModel extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 2893059152205731394L;
  ...
  private com.learning.kafkamodel.order.OrderApprovalStatus orderApprovalStatus;
   ...
   */
  public RestaurantApprovalResponseAvroModel(java.lang.String id, java.lang.String sagaId, java.lang.String restaurantId, java.lang.String orderId, java.time.Instant createdAt, com.learning.kafkamodel.order.OrderApprovalStatus orderApprovalStatus, java.util.List<java.lang.String> failureMessages) {
    this.id = id;
    this.sagaId = sagaId;
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 5: orderApprovalStatus = (com.learning.kafkamodel.order.OrderApprovalStatus)value$; break;
   ...
   */
  public com.learning.kafkamodel.order.OrderApprovalStatus getOrderApprovalStatus() {
   ...
   * @param value the value to set.
   */
  public void setOrderApprovalStatus(com.learning.kafkamodel.order.OrderApprovalStatus value) {
   ...
   */
  public static com.learning.kafkamodel.order.RestaurantApprovalResponseAvroModel.Builder newBuilder() {
    return new com.learning.kafkamodel.order.RestaurantApprovalResponseAvroModel.Builder();
  }
   ...
   * @return A new RestaurantApprovalResponseAvroModel RecordBuilder
   */
  public static com.learning.kafkamodel.order.RestaurantApprovalResponseAvroModel.Builder newBuilder(com.learning.kafkamodel.order.RestaurantApprovalResponseAvroModel.Builder other) {
    if (other == null) {
      return new com.learning.kafkamodel.order.RestaurantApprovalResponseAvroModel.Builder();
    } else {
      return new com.learning.kafkamodel.order.RestaurantApprovalResponseAvroModel.Builder(other);
    }
  }
   ...
   * @return A new RestaurantApprovalResponseAvroModel RecordBuilder
   */
  public static com.learning.kafkamodel.order.RestaurantApprovalResponseAvroModel.Builder newBuilder(com.learning.kafkamodel.order.RestaurantApprovalResponseAvroModel other) {
    if (other == null) {
      return new com.learning.kafkamodel.order.RestaurantApprovalResponseAvroModel.Builder();
    } else {
      return new com.learning.kafkamodel.order.RestaurantApprovalResponseAvroModel.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<RestaurantApprovalResponseAvroModel>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.learning.kafkamodel.order.RestaurantApprovalResponseAvroModel.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.learning.kafkamodel.order.RestaurantApprovalResponseAvroModel other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.id)) {
        this.id = data().deepCopy(fields()[0].schema(), other.id);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.learning.kafkamodel.order.RestaurantApprovalResponseAvroModel.Builder setId(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.learning.kafkamodel.order.RestaurantApprovalResponseAvroModel.Builder clearId() {
      id = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.learning.kafkamodel.order.RestaurantApprovalResponseAvroModel.Builder setSagaId(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.learning.kafkamodel.order.RestaurantApprovalResponseAvroModel.Builder clearSagaId() {
      sagaId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.learning.kafkamodel.order.RestaurantApprovalResponseAvroModel.Builder setRestaurantId(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.learning.kafkamodel.order.RestaurantApprovalResponseAvroModel.Builder clearRestaurantId() {
      restaurantId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.learning.kafkamodel.order.RestaurantApprovalResponseAvroModel.Builder setOrderId(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.learning.kafkamodel.order.RestaurantApprovalResponseAvroModel.Builder clearOrderId() {
      orderId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.learning.kafkamodel.order.RestaurantApprovalResponseAvroModel.Builder setCreatedAt(java.time.Instant value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.learning.kafkamodel.order.RestaurantApprovalResponseAvroModel.Builder clearCreatedAt() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.learning.kafkamodel.order.RestaurantApprovalResponseAvroModel.Builder setOrderApprovalStatus(com.learning.kafkamodel.order.OrderApprovalStatus value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.learning.kafkamodel.order.RestaurantApprovalResponseAvroModel.Builder clearOrderApprovalStatus() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.learning.kafkamodel.order.RestaurantApprovalResponseAvroModel.Builder setFailureMessages(java.util.List<java.lang.String> value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.learning.kafkamodel.order.RestaurantApprovalResponseAvroModel.Builder clearFailureMessages() {
    ...
    public RestaurantApprovalResponseAvroModel build() {
      try {
        ...
        record.orderApprovalStatus = fieldSetFlags()[5] ? this.orderApprovalStatus : (com.learning.kafkamodel.order.OrderApprovalStatus) defaultValue(fields()[5]);
