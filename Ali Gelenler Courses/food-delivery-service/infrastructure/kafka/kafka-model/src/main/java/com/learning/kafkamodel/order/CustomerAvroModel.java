...
public class CustomerAvroModel extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 4805304131182069418L;


  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"CustomerAvroModel\",\"namespace\":\"com.learning.kafkamodel.order\",\"fields\":[{\"name\":\"id\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"userName\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"firstName\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"lastName\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}}]}");
   ...
   */
  public static com.learning.kafkamodel.order.CustomerAvroModel.Builder newBuilder() {
    return new com.learning.kafkamodel.order.CustomerAvroModel.Builder();
  }
   ...
   * @return A new CustomerAvroModel RecordBuilder
   */
  public static com.learning.kafkamodel.order.CustomerAvroModel.Builder newBuilder(com.learning.kafkamodel.order.CustomerAvroModel.Builder other) {
    if (other == null) {
      return new com.learning.kafkamodel.order.CustomerAvroModel.Builder();
    } else {
      return new com.learning.kafkamodel.order.CustomerAvroModel.Builder(other);
    }
  }
   ...
   * @return A new CustomerAvroModel RecordBuilder
   */
  public static com.learning.kafkamodel.order.CustomerAvroModel.Builder newBuilder(com.learning.kafkamodel.order.CustomerAvroModel other) {
    if (other == null) {
      return new com.learning.kafkamodel.order.CustomerAvroModel.Builder();
    } else {
      return new com.learning.kafkamodel.order.CustomerAvroModel.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<CustomerAvroModel>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.learning.kafkamodel.order.CustomerAvroModel.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.learning.kafkamodel.order.CustomerAvroModel other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.id)) {
        this.id = data().deepCopy(fields()[0].schema(), other.id);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.learning.kafkamodel.order.CustomerAvroModel.Builder setId(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.learning.kafkamodel.order.CustomerAvroModel.Builder clearId() {
      id = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.learning.kafkamodel.order.CustomerAvroModel.Builder setUserName(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.learning.kafkamodel.order.CustomerAvroModel.Builder clearUserName() {
      userName = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.learning.kafkamodel.order.CustomerAvroModel.Builder setFirstName(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.learning.kafkamodel.order.CustomerAvroModel.Builder clearFirstName() {
      firstName = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.learning.kafkamodel.order.CustomerAvroModel.Builder setLastName(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.learning.kafkamodel.order.CustomerAvroModel.Builder clearLastName() {
      lastName = null;
