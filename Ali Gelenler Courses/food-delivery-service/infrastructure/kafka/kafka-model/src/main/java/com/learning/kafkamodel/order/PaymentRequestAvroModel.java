...
public class PaymentRequestAvroModel extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -8484420328253495871L;
  ...
  private com.learning.kafkamodel.order.PaymentOrderStatus paymentOrderStatus;
   ...
   */
  public PaymentRequestAvroModel(java.lang.String id, java.lang.String sagaId, java.lang.String customerId, java.lang.String orderId, java.math.BigDecimal price, java.time.Instant createdAt, com.learning.kafkamodel.order.PaymentOrderStatus paymentOrderStatus) {
    this.id = id;
    this.sagaId = sagaId;
  ...
  public void put(int field$, java.lang.Object value$) {
    ...
    case 6: paymentOrderStatus = (com.learning.kafkamodel.order.PaymentOrderStatus)value$; break;
    default: throw new IndexOutOfBoundsException("Invalid index: " + field$);
    }
  }
   ...
   */
  public com.learning.kafkamodel.order.PaymentOrderStatus getPaymentOrderStatus() {
   ...
   * @param value the value to set.
   */
  public void setPaymentOrderStatus(com.learning.kafkamodel.order.PaymentOrderStatus value) {
   ...
   */
  public static com.learning.kafkamodel.order.PaymentRequestAvroModel.Builder newBuilder() {
    return new com.learning.kafkamodel.order.PaymentRequestAvroModel.Builder();
  }
   ...
   * @return A new PaymentRequestAvroModel RecordBuilder
   */
  public static com.learning.kafkamodel.order.PaymentRequestAvroModel.Builder newBuilder(com.learning.kafkamodel.order.PaymentRequestAvroModel.Builder other) {
    if (other == null) {
      return new com.learning.kafkamodel.order.PaymentRequestAvroModel.Builder();
    } else {
      return new com.learning.kafkamodel.order.PaymentRequestAvroModel.Builder(other);
    }
  }
   ...
   * @return A new PaymentRequestAvroModel RecordBuilder
   */
  public static com.learning.kafkamodel.order.PaymentRequestAvroModel.Builder newBuilder(com.learning.kafkamodel.order.PaymentRequestAvroModel other) {
    if (other == null) {
      return new com.learning.kafkamodel.order.PaymentRequestAvroModel.Builder();
    } else {
      return new com.learning.kafkamodel.order.PaymentRequestAvroModel.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<PaymentRequestAvroModel>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.learning.kafkamodel.order.PaymentRequestAvroModel.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.learning.kafkamodel.order.PaymentRequestAvroModel other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.id)) {
        this.id = data().deepCopy(fields()[0].schema(), other.id);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.learning.kafkamodel.order.PaymentRequestAvroModel.Builder setId(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.learning.kafkamodel.order.PaymentRequestAvroModel.Builder clearId() {
      id = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.learning.kafkamodel.order.PaymentRequestAvroModel.Builder setSagaId(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.learning.kafkamodel.order.PaymentRequestAvroModel.Builder clearSagaId() {
      sagaId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.learning.kafkamodel.order.PaymentRequestAvroModel.Builder setCustomerId(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.learning.kafkamodel.order.PaymentRequestAvroModel.Builder clearCustomerId() {
      customerId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.learning.kafkamodel.order.PaymentRequestAvroModel.Builder setOrderId(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.learning.kafkamodel.order.PaymentRequestAvroModel.Builder clearOrderId() {
      orderId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.learning.kafkamodel.order.PaymentRequestAvroModel.Builder setPrice(java.math.BigDecimal value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.learning.kafkamodel.order.PaymentRequestAvroModel.Builder clearPrice() {
      price = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.learning.kafkamodel.order.PaymentRequestAvroModel.Builder setCreatedAt(java.time.Instant value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.learning.kafkamodel.order.PaymentRequestAvroModel.Builder clearCreatedAt() {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.learning.kafkamodel.order.PaymentRequestAvroModel.Builder setPaymentOrderStatus(com.learning.kafkamodel.order.PaymentOrderStatus value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.learning.kafkamodel.order.PaymentRequestAvroModel.Builder clearPaymentOrderStatus() {
    ...
    public PaymentRequestAvroModel build() {
      try {
        ...
        record.paymentOrderStatus = fieldSetFlags()[6] ? this.paymentOrderStatus : (com.learning.kafkamodel.order.PaymentOrderStatus) defaultValue(fields()[6]);
        return record;
